...
def commonTask():
    # 获取当前stock daily数据
    schedudler.add_job(getCurStockDailyData, 'cron', minute='42', hour='18', day_of_week='0-4')
    # 获取当前stock last 数据
    schedudler.add_job(getCurStockLastData, 'cron', minute='25', hour='15', day_of_week='0-4')
    # 获取当前plate daily 数据
    schedudler.add_job(getCurPlateDailyData, 'cron', minute='10', hour='17', day_of_week='0-4')
    # 获取当前plate last 数据
    schedudler.add_job(getCurPlateLastData, 'cron', minute='45', hour='16', day_of_week='0-4')
