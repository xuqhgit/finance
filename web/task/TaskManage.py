...
def commonTask():
    # 获取当前stock daily数据
    schedudler.add_job(getCurStockDailyData, 'cron', minute='*/1', hour='16-17', day_of_week='0-4')
    # 获取当前stock last 数据
    schedudler.add_job(getCurStockLastData, 'cron', minute='*/1', hour='19-20', day_of_week='0-4')
    # 获取当前plate daily 数据
    ...
    # 获取增减持数据
    schedudler.add_job(saveStockZJ, 'cron', minute='0', hour='8', day_of_week='0-4')
